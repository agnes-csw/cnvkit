#!/bin/bash
#
# CNVkit Pipeline Script (HPC - runs OUTSIDE container using apptainer exec)
...
if [[ ! -f "$REF_DIR/reference_2019.cnn" ]]; then
    ...
    $CNVKIT reference $NORMAL_CNN_ARGS \
        --fasta "$FASTA" \
